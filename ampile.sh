...
# perform fastqc
bash -c "$(curl -fsSL https://raw.githubusercontent.com/chenh19/Ampile/main/src/2.fastqc.sh)"

# trim and filter reads
bash -c "$(curl -fsSL https://raw.githubusercontent.com/chenh19/Ampile/main/src/3.trim.sh)"

# perform fastqc again
bash -c "$(curl -fsSL https://raw.githubusercontent.com/chenh19/Ampile/main/src/4.refastqc.sh)"

# align
bash -c "$(curl -fsSL https://raw.githubusercontent.com/chenh19/Ampile/main/src/5.bam.sh)"

# pileup
bash -c "$(curl -fsSL https://raw.githubusercontent.com/chenh19/Ampile/main/src/6.mpileup.sh)"

# parse
curl -fsSL https://raw.githubusercontent.com/chenh19/Ampile/main/src/7.parse.R | Rscript -
